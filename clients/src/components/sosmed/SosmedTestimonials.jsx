...
import PhotoKlien1 from '../../assets/images/sosmed-hero.png'; 
import PhotoKlien2 from '../../assets/images/sosmed-hero.png'; 
...
function SosmedTestimonials() {
  return (
    
    <section className="w-full px-4 md:px-8 lg:px-12 py-16 bg-gray-50"> 
      {}
      <div className="text-center max-w-2xl mx-auto mb-12">
        <h2 className="text-4xl font-bold mb-4" style={{background: 'linear-gradient(90deg, #DB2777 0%, #9333EA 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text'}}>Apa Kata Klien Kami</h2>
        <p className="text-lg text-gray-600">Testimoni dari klien yang puas dengan layanan Social Media kami</p>
      </div>
...
export default SosmedTestimonials;
